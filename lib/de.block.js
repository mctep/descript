...
de.Block.Array = function(array, options) {
    ...
    for (var i = 0, l = array.length; i < l; i++) {
        items.push( de.Block.compile( array[i], options ) );
    }
    this._nofuture_init(items);
};

no.inherit(de.Block.Array, de.Block, no.Future.Array.prototype);

de.Block.Array.prototype.after = function(result) {
...
de.Block.Object = function(object, options) {
    ...
    for (var key in object) {
        items[key] = de.Block.compile( object[key], options );
    }
    this._nofuture_init(items);
};

no.inherit(de.Block.Object, de.Block, no.Future.Object.prototype);

de.Block.Object.prototype.after = function(result) {
